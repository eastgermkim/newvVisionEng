...
<body>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="img/nv_logo.jpg" alt="" style="width: 100%; height: 120%;">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-7">
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                    	 <li><a href="#">NewVision E&G <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">회사소개</a></li>
                                                <li><a href="single-blog.html">CEO 인사말</a></li>
                                                <li><a href="single-blog.html">회사 연혁</a></li>
                                                <li><a href="single-blog.html">회사 조직도</a></li>
                                                <li><a href="single-blog.html">인증현황</a></li>
                                                <li><a href="single-blog.html">찾아오시는 길</a></li>
                                            </ul>
                                        </li>
                                    	 <li><a href="#">사업분야<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">사기업</a></li>
                                                <li><a href="single-blog.html">공기업</a></li>
                                                <li><a href="single-blog.html">군부대</a></li>
                                            </ul>
                                        </li>
                                    	 <li><a href="#">사업실적<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">사업 현황&실적</a></li>
                                                <li><a href="blog.html">주요 취급품목</a></li>
                                            </ul>
                                        </li>
                                    	 <li><a href="#">고객 지원<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">이메일 문의</a></li>
                                                <li><a href="single-blog.html">전화 문의</a></li>
                                                <li><a href="single-blog.html">공지사항</a></li>
                                            </ul>
                                        </li>
                                    	 <li><a href="#">채용 정보<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="blog.html">채용 정보 게시판</a></li>
                                            </ul>
                                        </li>
                                      </ul>
                                </nav>
    ...
    <div class="slider-area">
        <div class="slider-active owl-carousel">
            <div class="single-slider test1">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7 offset-xl-1 col-lg-7">
                            <div class="slider-content">
                                <p>hi this is my design</p>
                                <h3>광학기기</h3>
            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-3 col-xl-4">
                    <div class="single-footer-widget footer_1">
                        <a href="index.html"> <img src="img/footer-logo.png" alt="" style="width: 100%; height: 100%;"> </a>

	...
	<div class="container board">
		...
		<c:if test="${admin_Login_id != null and admin_Login_id != ''}">
			...
			<div class="board-view-header">
				<div class="inner">
					<ul class="info-wrap">
						<li class="item">${recruit.recruitWriter}</li>
						<li class="item">${recruit.recruitDate}</li>
					</ul>
					<h3 class="title-wrap">${recruit.recruitTitle}</h3>
				</div>
			</div>
			<div id="editor" rows="5" style="display: none;" readonly>${recruit.recruitContents}</div>
				<div class="board-view-bottom">
					...
					<div class="prevnext-btn-style">
							...
							<c:choose>
								<c:when test="${recruit.prevRecruitNum == null or recruit.prevRecruitNum == 0}">
							...
							<c:choose>
								<c:when test="${recruit.nextRecruitNum == null or recruit.nextRecruitNum == 0}">

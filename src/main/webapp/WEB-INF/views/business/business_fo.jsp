					...
					<div class="details-nav">
						<nav>
							<ul class="nav" id="myTab" role="tablist">
								...
								<li class="nav-item">
								<a class="nav-link active show" id="tab" href="../business/business_fo">광전송 SYSTEM</a></li>
							</ul>
						</nav>
					</div>
				</div>
						...
						<div class="tab-pane fade show active" id="business4" role="tabpanel"
							...
							<div class="details-wrap">
								<div class="details-info">
									...
									<video class="video" src="/resources/video/army_test(2).mp4" style="width:100%;" autoplay="autoplay" muted="muted"></video>
								</div>
							</div>
						</div>

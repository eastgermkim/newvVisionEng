   ...
   <c:import url="header.jsp" charEncoding="UTF-8"></c:import>
                ...
                <div class="col-xl-12">
                    <div class="brand-active owl-carousel">
                        <div class="single-brand">
                           <img src="resources/img/brand/1.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="resources/img/brand/2.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="resources/img/brand/3.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="resources/img/brand/4.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="resources/img/brand/5.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="resources/img/brand/6.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="resources/img/brand/4.png" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="single-service">
                        <div class="service-thumb">
                            <img src="resources/img/service/1.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single-service">
                        <div class="service-thumb">
                            <img src="resources/img/service/2.jpg" alt="">
                        </div>
    ...
    <div class="about-area section-padding">
        <div class="pattent-bg-img">
            <img src="resources/img/about/pattern.png" alt="">
        </div>
        <div class="container">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="about-info-text">
                            ...
                            <div class="about-author">
                                <div class="autor-thumb">
                                    <img src="resources/img/about/about-author.jpg" alt="">
                                </div>
                    ...
                    <div class="col-xl-5 offset-xl-1 col-md-6">
                        <div class="about-review">
                            <img src="resources/img/about/about-project.jpg" alt="">

...
CREATE TABLE NV_NEWS_IMG(
  ...
  SELECT * FROM NV_NEWS WHERE NEWSLINK IS NULL AND NEWSNUM > 38 LIMIT 1;
 
  SELECT * FROM NV_NEWS WHERE NEWSLINK IS NULL AND NEWSNUM < 38 ORDER BY NEWSNUM DESC LIMIT 1;

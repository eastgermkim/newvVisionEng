...
CREATE TABLE NV_BUSINESS_RESULT_IMG(
   ...
   BASIC_OR_NOT INT NOT NULL, /*기본이미지 사용시 0, 다른 이미지 첨부시 1*/
   SYSTEMNAME VARCHAR(255) UNIQUE, /*다른 이미지 첨부시 - 저장되는 파일명*/
   ORGNAME VARCHAR(1000), /*다른 이미지 첨부시 - 원래 파일명*/
...
INSERT INTO NV_BUSINESS_RESULT_IMG(RESULTNUM,BASIC_OR_NOT) VALUES(2,0);
